...
export const OmnichannelInbox: React.FC<OmnichannelInboxProps> = ({
  ...
  const getChannelBadge = (channel: ChannelType) => {
    switch (channel) {
      ...
      default:
        return { name: channel, icon: 'fa-solid fa-message', color: 'bg-slate-100 text-slate-700 border-slate-200' };
    }
  };
  ...
  const getStatusBadge = (status: TicketStatus) => {
    switch (status) {
      ...
      case 'auto_resolved':
        return <span className="px-2.5 py-1 rounded text-[11px] font-bold bg-purple-50 text-purple-800 border border-purple-300 inline-flex items-center gap-1.5"><i className="fa-solid fa-robot text-[10px]"></i> AI Xử lý xong</span>;
      case 'scheduled_callback':
        return <span className="px-2.5 py-1 rounded text-[11px] font-bold bg-indigo-50 text-indigo-800 border border-indigo-300 inline-flex items-center gap-1.5"><i className="fa-solid fa-clock text-[10px]"></i> Hẹn gọi lại</span>;
    }
  };
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="bg-white border border-slate-200 rounded-xl px-4 py-2.5 sm:px-5 sm:py-3 flex items-center justify-between gap-4 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-black text-slate-900 tracking-tight">Hộp Thư</h2>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-slate-800 font-bold">5/5 Kênh Trực Tuyến</span>
          </div>
      ...
      {viewMode === 'dashboard' ? (
        <div className="space-y-3 animate-in fade-in duration-150">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5">
            ...
            <div className="bg-white border border-slate-200 rounded-lg px-3 py-2 flex items-center justify-between shadow-2xs">
              <div>
                <span className="text-[10px] text-slate-500 font-bold uppercase block leading-none">Tổng tiếp nhận</span>
                <span className="text-lg font-black text-slate-900 mt-1 block leading-tight">{totalCount}</span>
              </div>
              <span className="w-7 h-7 rounded bg-slate-100 text-slate-700 flex items-center justify-center text-xs">
                <i className="fa-solid fa-inbox"></i>
              </span>
            </div>

            <div className="bg-white border border-red-200 rounded-lg px-3 py-2 flex items-center justify-between shadow-2xs">
              <div>
              ...
              <span className="w-7 h-7 rounded bg-red-50 text-[#a81c1c] border border-red-200 flex items-center justify-center text-xs">
                <i className="fa-solid fa-triangle-exclamation"></i>
              </span>
            </div>

            <div className="bg-white border border-amber-200 rounded-lg px-3 py-2 flex items-center justify-between shadow-2xs">
              <div>
              ...
              <span className="w-7 h-7 rounded bg-amber-50 text-amber-700 border border-amber-200 flex items-center justify-center text-xs">
                <i className="fa-solid fa-clock"></i>
              </span>
            </div>

            <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center justify-between shadow-2xs">
              <div>
              ...
              <span className="w-7 h-7 rounded bg-blue-50 text-blue-700 border border-blue-200 flex items-center justify-center text-xs">
                <i className="fa-solid fa-headset"></i>
              </span>
            </div>

            <div className="bg-white border border-purple-200 rounded-lg px-3 py-2 flex items-center justify-between shadow-2xs">
              <div>
              ...
              <span className="w-7 h-7 rounded bg-purple-50 text-purple-700 border border-purple-200 flex items-center justify-center text-xs">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs space-y-3">
            ...
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 text-slate-900 pl-9 pr-8 py-2.5 rounded-lg text-xs border border-slate-300 focus:border-[#a81c1c] focus:bg-white focus:outline-none placeholder:text-slate-400 transition-colors"
                />
                {searchQuery && (
                  <button
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <select
                  ...
                  className="bg-white text-slate-800 text-xs px-3 py-2 rounded-lg border border-slate-300 focus:border-[#a81c1c] outline-none font-semibold"
                >
            ...
            <div className="flex items-center gap-2 overflow-x-auto custom-scrollbar pt-1 text-xs">
              <span className="text-slate-600 font-bold shrink-0 text-[11px]">Kênh tiếp nhận:</span>
              ...
              >
                <i className="fa-solid fa-landmark text-red-600"></i>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
            ...
            <div className="p-3.5 border-b border-slate-200 bg-[#f8fafc] flex items-center justify-between">
              <div className="flex items-center gap-2">
                <i className="fa-solid fa-list-check text-[#a81c1c] text-sm"></i>
                <h3 className="font-black text-sm text-slate-900">Danh Sách Tin Nhắn Tiếp Nhận Đang Xử Lý</h3>
                <span className="text-xs text-slate-500 font-semibold">({filteredTickets.length} hồ sơ)</span>
              </div>
              <span className="text-xs text-slate-600 font-semibold hidden sm:inline">
                💡 <span className="text-[#a81c1c] font-black">Nhấp vào hàng</span> để mở Màn hình Chat và Trợ lý AI
              </span>
            </div>

            {filteredTickets.length === 0 ? (
              <div className="p-12 text-center text-slate-500">
                <i className="fa-solid fa-inbox text-4xl mb-3 text-slate-300 block"></i>
                <p className="text-sm font-bold text-slate-700">Không tìm thấy yêu cầu nào phù hợp.</p>
                <button
                  onClick={() => {
                    setSearchQuery('');
                  ...
                  className="mt-3 px-3 py-1.5 bg-slate-100 text-[#a81c1c] hover:bg-red-50 rounded-lg text-xs font-bold border border-slate-300"
                >
                  Xóa bộ lọc tìm kiếm
                </button>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-700">
                  <thead className="bg-[#f1f5f9] text-slate-700 uppercase text-[10px] font-black tracking-wider border-b border-slate-200">
                    <tr>
                      <th className="py-3 px-4">Kênh & Thời gian</th>
                      <th className="py-3 px-4">Công dân / Tổ chức</th>
                      <th className="py-3 px-4">Nội dung tin nhắn & Yêu cầu</th>
                      <th className="py-3 px-4">Lĩnh vực & Chẩn đoán AI</th>
                      <th className="py-3 px-4">Độ khẩn</th>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <div className="font-bold text-slate-900 text-xs group-hover:text-[#a81c1c] transition-colors">
                              {ticket.citizenName}
                            </div>
                          ...
                          <td className="py-3 px-4 whitespace-nowrap">
                            <div className="font-bold text-slate-800 text-[11px] flex items-center gap-1">
                              <i className="fa-regular fa-folder text-[#a81c1c] text-[10px]"></i>
                              {ticket.category}
                            </div>
                          ...
                          <td className="py-3 px-4 text-right whitespace-nowrap">
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                handleSelectMessageToChat(ticket);
                              }}
                              className="px-3 py-1.5 bg-[#a81c1c] hover:bg-[#8b0000] text-white rounded-lg font-bold text-xs shadow-xs transition-all flex items-center gap-1.5 ml-auto"
                            >
                              <span>Xử lý & Chat AI</span>
        ...
        <div className="space-y-3 animate-in fade-in duration-150">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-3 flex flex-wrap items-center justify-between gap-3 shadow-xs">
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-lg text-xs font-bold border border-slate-300 flex items-center gap-1.5 transition-colors"
              >
                <i className="fa-solid fa-arrow-left text-xs text-[#a81c1c]"></i>
                <span>Quay lại Dashboard Tin Nhắn</span>
              </button>
              ...
              {selectedTicket && (
                <div className="flex items-center gap-2 text-xs">
                  <span className="text-slate-500 hidden sm:inline">Hồ sơ tiếp nhận:</span>
                  <span className="font-bold text-slate-900">{selectedTicket.citizenName}</span>
                  <span className="font-mono text-blue-700 font-bold">({selectedTicket.id})</span>
                  <span className="text-slate-400">•</span>
                  <span className="text-slate-600 font-semibold">{selectedTicket.channelName}</span>
                </div>
              )}
            </div>
            ...
            {selectedTicket && (
              <div className="flex items-center gap-2">
                <span className="text-xs text-slate-600 font-bold hidden sm:inline">Cập nhật trạng thái:</span>
                <select
                  value={selectedTicket.status}
                  onChange={(e) => onUpdateStatus(selectedTicket.id, e.target.value as TicketStatus)}
                  className="bg-white text-slate-900 text-xs px-3 py-1.5 rounded-lg border border-slate-300 focus:border-[#a81c1c] outline-none font-bold shadow-xs"
                >
                  <option value="pending">Chờ tiếp nhận</option>
                  <option value="processing">Đang thụ lý</option>
                  <option value="resolved">Đã giải quyết</option>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-[700px]">
            ...
            <div className="lg:col-span-3 xl:col-span-3 bg-white border border-slate-200 rounded-xl flex flex-col overflow-hidden shadow-xs">
              
              <div className="p-3 border-b border-slate-200 space-y-2 bg-[#f8fafc]">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black text-slate-900 flex items-center gap-1.5">
                    <i className="fa-solid fa-list-ul text-[#a81c1c] text-xs"></i>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white text-slate-900 pl-8 pr-3 py-1.5 rounded-lg text-xs border border-slate-300 focus:border-[#a81c1c] focus:outline-none placeholder:text-slate-400"
                  />
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-0.5">
                        <h4 className="font-bold text-xs text-slate-900 truncate pr-1">
                          {ticket.citizenName}
                        </h4>
                        <span className="font-mono text-[9px] text-blue-700 shrink-0">#{ticket.id}</span>
                      </div>

                      <p className="text-[11px] text-slate-600 line-clamp-1 leading-snug mb-1">
                        {ticket.lastMessage}
                      </p>
            ...
            <div className="lg:col-span-5 xl:col-span-5 bg-white border border-slate-200 rounded-xl flex flex-col overflow-hidden shadow-xs">
              {selectedTicket ? (
                <>
                  {/* Active Chat Header */}
                  <div className="p-3.5 border-b border-slate-200 bg-[#f8fafc] flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="font-bold text-xs sm:text-sm text-slate-900">{selectedTicket.citizenName}</h3>
                          <span className="text-[10px] font-mono text-blue-700 font-bold">{selectedTicket.phone}</span>
                        </div>
                        <p className="text-[11px] text-slate-500 flex items-center gap-1">
                          <span>Mã hồ sơ: <strong className="text-slate-800">{selectedTicket.id}</strong></span>
                          <span>•</span>
                          <span>Kênh: <strong className="text-slate-800">{selectedTicket.channelName}</strong></span>
                        </p>
                      </div>
                    </div>

                    <div className="flex items-center gap-1.5 text-xs text-slate-600">
                      <span className="text-[10px] bg-white px-2 py-1 rounded border border-slate-200 font-semibold shadow-2xs">
                        Phụ trách: <strong className="text-slate-800">{selectedTicket.assignedOfficer}</strong>
                      </span>
                    </div>
                  </div>

                  {/* Chat Thread Messages */}
                  <div className="flex-1 overflow-y-auto p-4 space-y-3.5 bg-[#f8fafc]/50 custom-scrollbar text-xs">
                  ...
                  <div className="px-3 py-2 bg-slate-50 border-t border-slate-200 flex items-center justify-between text-[11px] gap-2">
                    <div className="flex items-center gap-1.5 overflow-x-auto custom-scrollbar">
                      <span className="text-slate-500 shrink-0 font-bold text-[10px]">Mẫu nhanh:</span>
                      <button
                        ...
                        className="shrink-0 px-2 py-0.5 bg-white hover:bg-slate-100 text-slate-700 rounded border border-slate-200 text-[10px] font-medium transition-colors"
                      >
                        Đã nhận hồ sơ
                      </button>
                      <button
                  ...
                  <form onSubmit={handleSend} className="p-3 bg-white border-t border-slate-200 flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 bg-slate-50 text-slate-900 px-3.5 py-2 rounded-lg border border-slate-300 focus:border-[#a81c1c] focus:bg-white outline-none text-xs"
                    />
                    <button
                      type="submit"
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-slate-400">
                  <i className="fa-regular fa-comment-dots text-4xl mb-3 text-slate-300"></i>
                  <p className="text-sm font-semibold text-slate-600">Chọn một tin nhắn từ danh sách bên trái để mở hội thoại.</p>
                </div>
              )}
            </div>

            {/* COLUMN 3: RIGHT AI ASSISTANT & LEGAL CITATIONS PANEL (4 Cols) */}
            <div className="lg:col-span-4 xl:col-span-4 bg-white border border-slate-200 rounded-xl flex flex-col overflow-hidden shadow-xs">
              {selectedTicket ? (
                <>
                  {/* Panel Header */}
                  <div className="p-3.5 border-b border-slate-200 bg-gradient-to-r from-red-50 to-slate-50 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h3 className="font-bold text-xs text-slate-900">Trợ Lý AI Phân Tích & Căn Cứ Pháp Lý</h3>
                        <span className="text-[10px] text-slate-500">Khớp dữ liệu TTHC Quốc gia 2026</span>
                      </div>
                    </div>
                    <span className="px-2 py-0.5 bg-emerald-100 text-emerald-800 border border-emerald-300 rounded text-[10px] font-bold">
                      {selectedTicket.aiAnalysis.confidenceScore}% Tin cậy
                    </span>
                  </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4 text-xs custom-scrollbar">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 space-y-1.5">
                      <div className="text-[11px] font-bold text-slate-700 flex items-center gap-1.5">
                        <i className="fa-solid fa-file-waveform text-blue-700"></i>
                        <span>Tóm tắt nhu cầu công dân</span>
                      </div>
                      <p className="text-slate-800 leading-relaxed font-medium">
                        {selectedTicket.aiAnalysis.summary}
                      </p>
                      <div className="pt-1.5 border-t border-slate-200 flex flex-wrap items-center gap-2 text-[10px]">
                        <span className="text-slate-500 font-semibold">Mục đích:</span>
                    ...
                    <div className="bg-amber-50/50 border border-amber-200 rounded-lg p-3 space-y-2">
                      ...
                      <div className="p-2.5 bg-white border border-amber-200 rounded text-slate-800 text-xs leading-relaxed whitespace-pre-wrap font-medium">
                    ...
                    <div className="bg-red-50/40 border border-red-200 rounded-lg p-3 space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-[11px] font-bold text-[#a81c1c] flex items-center gap-1.5">
                          <i className="fa-solid fa-book-bookmark text-red-700"></i>
                      ...
                      <div className="p-2 bg-white border border-red-100 rounded text-slate-800 text-[11px] font-semibold flex items-center gap-2">
                        <i className="fa-solid fa-gavel text-[#a81c1c]"></i>
                    ...
                    <div className="pt-2 border-t border-slate-200 space-y-2">
                      <div className="text-[11px] font-bold text-slate-700 flex items-center gap-1.5">
                        <i className="fa-solid fa-link text-[#a81c1c]"></i>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {onNavigateToFAQ && (
                          ...
                          >
                            <i className="fa-solid fa-book-bookmark text-emerald-700"></i>
                        ...
                        {onCreateBroadcastFromTicket && (
                          ...
                          >
                            <i className="fa-solid fa-bullhorn text-amber-700"></i>
                    ...
                    {/* Internal Case Note (Ghi chú ca trực) */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-bold text-slate-700 flex items-center gap-1.5">
                        <i className="fa-regular fa-pen-to-square text-slate-600"></i>
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full bg-slate-50 text-slate-900 p-2.5 rounded-lg border border-slate-300 focus:border-[#a81c1c] focus:bg-white text-xs outline-none"
                      />
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-slate-400">
                  <i className="fa-solid fa-robot text-4xl mb-3 text-slate-300"></i>
                  <p className="text-sm font-semibold text-slate-600">Trợ lý AI sẽ tự động phân tích và trích dẫn luật khi bạn chọn một hồ sơ.</p>
                </div>
              )}
            </div>
